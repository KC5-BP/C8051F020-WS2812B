...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_A_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_B_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_C_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_D_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_E_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_F_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_G_Big[OFF_CHAR_DIM_4X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_H_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_I_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_J_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_K_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_L_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_M_Big[OFF_CHAR_DIM_5X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_N_Big[OFF_CHAR_DIM_4X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_O_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_P_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_Q_Big[OFF_CHAR_DIM_4X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_R_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_S_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_T_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_U_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_V_Big[OFF_CHAR_DIM_5X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_W_Big[OFF_CHAR_DIM_5X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_X_Big[OFF_CHAR_DIM_4X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_Y_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_Z_Big[OFF_CHAR_DIM_4X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 								break;
// 							case enu_Big:
// 								_addMatrix[NeoPix_Pos].ui8_Status = cBoard_Space_Big[OFF_CHAR_DIM_3X14 - CharReadOrga];
// 								break;
// 							default :	/* State of every undefined case, so not supposed to come here. */	break;
// 						}
// 						break;
...
// 					
// 					case ')':
// 						_addMatrix[NeoPix_Pos].ui8_Status = cBoard_CloseBracket[OFF_CHAR_DIM_5X7 - CharReadOrga];
// 						break;
// 					
// 					case '\n':
// 						Offset.ui8_Colu = 1;
...
void Matrix_InvertArray(tstr_NeoPixel* _addMatrix)
{	// Var. Dec. :
	xdata uint16 i;	// LED Position for filling Board of neoPix.
	xdata uint16 j;	// Address recovering counter of the matrix.
	// To avoid problems about the parameters, I prefered to work with copies.
	tstr_NeoPixel* AddSave = _addMatrix;
	xdata tstr_Color tmp = {0, 0, 0};
	
	for(i = 0; i < MAX_LED; i++)
	{
		if((_addMatrix->Col_Pix.ui8_Red != 0) || (_addMatrix->Col_Pix.ui8_Green != 0) || (_addMatrix->Col_Pix.ui8_Blue != 0))
		{
			tmp.ui8_Red = _addMatrix->Col_Pix.ui8_Red;
			tmp.ui8_Green = _addMatrix->Col_Pix.ui8_Green;
			tmp.ui8_Blue = _addMatrix->Col_Pix.ui8_Blue;
			break;
		}
		_addMatrix++;
	}
	...
	for(i = 0; i < MAX_LED; i++)
	{
		if(_addMatrix->ui8_Status == 0)
		{
			_addMatrix->ui8_Status = 1;
			_addMatrix->Col_Pix.ui8_Red = tmp.ui8_Red;
			_addMatrix->Col_Pix.ui8_Green = tmp.ui8_Green;
			_addMatrix->Col_Pix.ui8_Blue = tmp.ui8_Blue;
		}
		else
		{
			_addMatrix->ui8_Status = 0;
