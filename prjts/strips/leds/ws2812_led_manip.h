...
//#include <c8051f020.h> // <- Would add it for P2.

//===================================================
//================================\HEADER'S_Definitions/================================>
#ifndef __ws2812_led_manip_h__
#define __ws2812_led_manip_h__    // __WS2812_LED_MANIP__ BEGIN
...
//----------------------------------\OUTPUT_Definition/---------------------------------.
#ifndef P2
sfr RESOLV_SYMBOL = 0xA0;
#endif
// '-> PIN Definition : sbit /!\ FROM 0 /!\ :
sbit SBIT_OUT_STRIP = RESOLV_SYMBOL ^ 4;
