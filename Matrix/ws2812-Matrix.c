...
#include <intrins.h>
//#include "base_sfr.h"	// ... Base(global define, sbit, sfr, typedef, ...)
//#include "time.h"		// ... Timers function and Waiting Function.
#include "ws281x_matrix.h"	// ... Timers function and Waiting Function.
...
{	// Var. Dec. :
   ...
   addressMatrix->position = position;
...
{	// Var. Dec. :
	...
	{	// Clear ALL Color in the original addresses ...
      ...
      addressMatrix->position = 0; // Clear position ..
...
{
   Offset.ui8_Colu = column;
   Offset.ui8_Line = line;
}
