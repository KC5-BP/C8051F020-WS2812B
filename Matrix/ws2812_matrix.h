...
//#include "../F12-NeoPix_MatrixPrButt/base_sfr.h"	
...
#define MAX_LEDS 256 // Number of LEDs used with Matrix
#define MATRIX_NBR 1
// Type of Matrix ...
#define MAX_LINE 16
 ...
 * Output	 	:	Nothin'                                                                  */
extern void pixel_SetColor(pixel* addressMatrix, color newColor, \
 ...
 *						position, 2bytes - position in the matrix to set the color.
 * Output	 	:	Nothin'                                                                  */
extern void strip_LedChain(pixel* addressMatrix, color newColor, \
